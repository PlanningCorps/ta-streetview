...
function svc_feedback() {
  ...
  if ($request_body) {
    ...
    svc_post_comment($request->intersection_id, $request->heading, $request->pitch, $request->zoom, $request->desc, $request->email);
  }
}

function svc_post_comment($post_id, $heading, $pitch, $zoom, $desc, $email) {
    ...
    <div class="dot-feedback-container">
      ...
      <form class="dot-survey-form">
        <label class="dot-survey-form-label" for="dot-survey-desc">
          Point Google Streetview directly at the issue you want to highlight, then leave a comment.
        </label>
